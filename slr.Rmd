...
ggplot(data=MAPE.all) + 
  ...
  labs(title="MAPEbase, MAPE1, MAPE5, MAPE10 as obs increases", subtitle="obs # is the amount of original data from which model is based", caption="MAPEbase=yellow,  MAPE1=green,  MAPE5=blue,  MAPE10=purple")
dev.off()
